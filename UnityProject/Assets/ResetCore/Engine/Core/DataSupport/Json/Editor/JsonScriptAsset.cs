...
namespace ResetCore.Json
{
    ...
    {
        //Json模板资源路径
        public static readonly string jsonScriptAssetPath = 
            PathConfig.ResetCorePath + "Engine/Core/DataSupport/Json/Editor/JsonAsset.json".Replace(PathConfig.projectPath, "");
        ...
        public static void CreateNewLua()
        {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, ScriptableObject.CreateInstance<JsonAsset>(),
                GetSelectedPathOrFallBack() + "/NewData.json", null, jsonScriptAssetPath);
        }
