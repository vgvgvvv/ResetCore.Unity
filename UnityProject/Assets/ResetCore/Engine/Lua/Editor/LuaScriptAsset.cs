...
public class LuaScriptAsset {
    ...
    //Lua模板资源路径
    public static readonly string luaScriptAssetPath = PathConfig.ResetCorePath + "Engine/Lua/Editor/LuaAsset.lua".Replace(PathConfig.projectPath, "");
    ...
    public static void CreateNewLua()
    {
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, ScriptableObject.CreateInstance<LuaAsset>(),
            GetSelectedPathOrFallBack() + "/NewLua.txt", null, luaScriptAssetPath);
    }
