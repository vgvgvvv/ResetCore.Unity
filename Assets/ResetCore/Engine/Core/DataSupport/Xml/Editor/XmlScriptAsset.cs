...
namespace ResetCore.Xml
{
    public class XmlScriptAsset
    {
        ...
        //Xml模板资源路径
        public static readonly string xmlScriptAssetPath = 
            PathConfig.ResetCorePath + "Engine/Core/DataSupport/Xml/Editor/XmlAsset.xml".Replace(PathConfig.projectPath, "");
        ...
        public static void CreateNewLua()
        {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, ScriptableObject.CreateInstance<XmlAsset>(),
                GetSelectedPathOrFallBack() + "/NewData.xml", null, xmlScriptAssetPath);
        }
